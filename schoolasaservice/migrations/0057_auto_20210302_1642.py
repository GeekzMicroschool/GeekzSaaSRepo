# Generated by Django 3.0.8 on 2021-03-02 11:12
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('schoolasaservice', '0056_auto_20210302_1609'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='schoolasaservice.studentApplication')),
            ],
        ),
        migrations.AlterField(
            model_name='inquirys',
            name='date',
            field=models.DateTimeField(blank=True, default=datetime.datetime(2021, 3, 2, 16, 42, 3, 882437)),
        ),
