...
urlpatterns = [
    ...
    path('studentinquiryadmin',views.studentinquiryadmin,name="studentinquiryadmin"),
    ...
    path('Studentfeedbackprofiling',views.Studentfeedbackprofiling,name="Studentfeedbackprofiling"),
    path('StudentprofileMessage/<id>',views.StudentprofileMessage,name="StudentprofileMessage"),
    ...
    path('SaaSProfileFeedback',views.SaaSProfileFeedback,name="SaaSProfileFeedback"),
    path('SaaSprofileMessage/<uid>',views.SaaSprofileMessage,name="SaaSprofileMessage"),
    path('studentProfilingadmin_Approve',views.studentProfilingadmin_Approve,name="studentProfilingadmin_Approve"),
